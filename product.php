					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab">Địa chỉ mua hàng</a></li>
                                <li role="presentation"><a href="#condition" aria-controls="condition" role="tab" data-toggle="tab">Hướng dẫn sử dụng</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    ...
                    <h3>Xem các sản phẩm liên quan</h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>">Xem ngay</a></p>
                            </div>
                        </div>
                        <?php
                    }
