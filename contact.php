...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Xin hãy nhập tên của bạn.\n';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Xin vui lòng điền số điện thoại của bạn.\n';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Hãy điền địa chỉ email của bạn.\n';
    }
    else
    {
...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="visitor_phone" placeholder="Nhập SĐT">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="submit" value="Gửi" class="btn btn-primary pull-right" name="form_contact">
                                </div>
                            </div>
                            </form>
                        </div>
                    ...
                    <div class="col-md-4">
                        <legend><span class="glyphicon glyphicon-globe"></span>Thông tin</legend>
                        <address>
