...
<head>
	...
	if($cur_page == 'dashboard.php') {
		?>
		<title>Trang cá nhân - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
	...
	if($cur_page == 'customer-billing-shipping-update.php') {
		?>
		<title>Địa chỉ & Thanh toán - <?php echo $meta_title_home; ?></title>
		<meta name="keywords" content="<?php echo $meta_keyword_home; ?>">
		<meta name="description" content="<?php echo $meta_description_home; ?>">
		<?php
	}
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						<li><a href="dashboard.php"><i class="fa fa-home"></i> Trang cá nhân</a></li>
						<?php
					} else {
						?>
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<div class="form-group">
						<input type="text" class="form-control search-top" placeholder="Nhập tên sản phẩm" name="search_text">
					</div>
	...
	<div class="container" >
		<div class="row">
			<div class="col-md-12 pl_0 pr_0">
				<div class="menu-container" style="background-color: red;">
					<div class="menu" >
						<ul>
