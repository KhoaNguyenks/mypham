...
if (isset($_POST['form1'])) {
    ...
    if( empty($_POST['cust_password']) || empty($_POST['cust_re_password']) ) {
        $valid = 0;
        $error_message .= "Không được để trống!<br>";
    }

    if( !empty($_POST['cust_password']) && !empty($_POST['cust_re_password']) ) {
        if($_POST['cust_password'] != $_POST['cust_re_password']) {
            $valid = 0;
            $error_message .= "Gõ lại mật khẩu không trùng khớp!<br>";
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = "Cập nhật mật khẩu thành công!<br>";
    }
}
?>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="submit" class="btn btn-primary" value="Đặt" name="form1">
                            </div>
                        </div>
