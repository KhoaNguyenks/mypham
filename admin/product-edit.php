...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn ngành hàng<br>";
    }

    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn phân loại hàng<br>";
    }

    if(empty($_POST['p_name'])) {
        $valid = 0;
        $error_message .= "Tên sản phẩm không dược để trống<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Sản phẩm cập nhật thành công.';
    }
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Phân loại hàng <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Giá mới <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In USD)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Kích thước</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Thay ảnh </label>
							<div class="col-sm-4" style="padding-top:4px;">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Địa chỉ mua chính hãng</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Được nổi bật?</label>
							<div class="col-sm-8">
