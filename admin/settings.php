...
if(isset($_POST['form5'])) {
    ...
    $success_message = 'Sidebar được cập nhật thành công.';
}
...
if(isset($_POST['form6_0'])) {
    ...
    $success_message = 'Section On-Off được cập nhật thành công.';
}
...
if(isset($_POST['form6'])) {
    ...
    $success_message = 'Home Meta được cập nhật thành công.';
}
...
if(isset($_POST['form10'])) {
    ...
    $success_message = 'Tập lệnh Head and Body được cập nhật thành công.';
}
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_2" data-toggle="tab">yêu thích</a></li>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Ảnh hiện có</label>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form2">Cập nhật yêu thích</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="newsletter_on_off" class="form-control" style="width:auto;">
                                                <option value="1" <?php if($newsletter_on_off == 1) {echo 'selected';} ?>>Không</option>
                                                <option value="0" <?php if($newsletter_on_off == 0) {echo 'selected';} ?>>Có</option>
                                            </select>
                                        </div>
                                    </div>
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Bản đồ liên hệ </label>
                                        <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Biểu ngữ trang Quên mật khẩu hiện có</h4>
                                        <p>
