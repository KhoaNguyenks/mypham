...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
        $valid = 0;
        $error_message .= "Kích thước không được để trống<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Kích thước đã tồn tại<br>';
    	}
    }
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Kích thước <span>*</span></label>
                    <div class="col-sm-4">
