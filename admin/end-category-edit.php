...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['ecat_name'])) {
        $valid = 0;
        $error_message .= "Phân loại hàng không được để trống!<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Phân loại hàng được cập nhật thành công!';
    }
}
?>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <button type="submit" class="btn btn-success pull-left" name="form1">Sửa</button>
                    </div>
                </div>
