					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>
                        	...
                        	<?php elseif($row['payment_method'] == 'Bank Deposit'): ?>
                        		...
                        		<b>Mã thanh toán:</b> <?php echo $row['payment_id']; ?><br>
								<b>Ngày:</b> <?php echo $row['payment_date']; ?><br>
                        		<b>Mã giao dịch:</b> <br><?php echo $row['bank_transaction_info']; ?><br>
                        	<?php endif; ?>
                        </td>
                        <td><?php echo $row['paid_amount']; ?> VNĐ</td>
                        <td>
                            ...
                            <?php
                                if($row['payment_status']=='Pending'){
                                    ?>
                                    <a href="order-change-status.php?id=<?php echo $row['id']; ?>&task=Hoàn thành" class="btn btn-success btn-xs" style="width:100%;margin-bottom:4px;">Hoàn tất</a>
                                    <?php
                                }
                            ?>
                        </td>
                        <td>
                            ...
                            if($row['payment_status']=='Hoàn thành') {
                                if($row['shipping_status']=='Pending'){
                                    ?>
                                    <a href="shipping-change-status.php?id=<?php echo $row['id']; ?>&task=Hoàn thành" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Hoàn tất</a>
                                    <?php
                                }
                            }
                            ?>
