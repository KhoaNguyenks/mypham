...
if(isset($_POST['form_about'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Page được cập nhật thành công!';
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'FAQ Page được cập nhật thành công!';
...
if(isset($_POST['form_contact'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Trang thông tin liên hệ được cập nhật thành công .';
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Tiêu đề page * </label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="about_title" value="<?php echo $about_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Nội dung page * </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="about_content" id="editor1"><?php echo $about_content; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Ảnh biểu ngữ hiện có</label>
