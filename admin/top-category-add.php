...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Danh mục không được để trống<br>";
    } else {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Danh mục được thêm thành công.';
    }
}
?>
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Hiển thị lên menu? <span>*</span></label>
							<div class="col-sm-4">
