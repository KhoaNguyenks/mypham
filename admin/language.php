...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <h3 style="font-size:20px;font-weight:500;"></h3>
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tìm sản phẩm <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Xác nhận <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tiếp <span>*</span></label>
                    <div class="col-sm-6">
		...
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đăng nhập với tư cách là <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Sửa giỏ hàng <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[20]" value="<?php echo $lang_ids[20]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thêm giỏ hàng <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đặt hàng <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[24]" value="<?php echo $lang_ids[24]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Lịch sử đặt hàng <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Ngày giờ thanh toán <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thành tiền <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mã thanh toán <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[32]" value="<?php echo $lang_ids[32]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Khu thanh toán <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chọn phương thức <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">COD <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[37]" value="<?php echo $lang_ids[37]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Smartbanking <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[38]" value="<?php echo $lang_ids[38]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Card ATM <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Gửi thông tin chi tiết <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Gồm mã giao dịch và thông tin khác một cách chính xác<span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">				
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thông tin chi tiết <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[48]" value="<?php echo $lang_ids[48]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Sản phẩm tương tự <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chia sẻ sản phẩm <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đưa ra Review <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[65]" value="<?php echo $lang_ids[65]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Viết bình luận của bạn (Nếu muốn) <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[66]" value="<?php echo $lang_ids[66]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Hoàn thành Review <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Không tìm thấy Review <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Sau <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
            	<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Giá vận chuyển <span>*</span></label>
                    <div class="col-sm-6">
		...
		<h3 style="font-size:20px;font-weight:500;">Thống kê</h3>
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thống kê <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[89]" value="<?php echo $lang_ids[89]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chào mừng đến với Bảng thống kê <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[90]" value="<?php echo $lang_ids[90]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Quay lại Bảng thống kê <span>*</span></label>
                    <div class="col-sm-6">
		...
		<h3 style="font-size:20px;font-weight:500;">Đặt mua</h3>
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đặt mua <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Điền địa chỉ email của bạn <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Gõ lại mật khẩu <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Gõ lại mật khẩu mới <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Địa chỉ chi tiết <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Huyện <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[107]" value="<?php echo $lang_ids[107]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Xã <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[108]" value="<?php echo $lang_ids[108]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mã zipcode <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Bản đồ <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Huyện không thể trống rỗng. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[127]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[127]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Xã không thể trống rỗng. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[128]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[128]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">ZipCode không thể trống rỗng. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Email không thể để trống. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[131]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[131]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Email và/hoặc Mật khẩu không thể để trống. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[132]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[132]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Email không giống. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mật khẩu không phù hợp. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[139]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[139]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Vui lòng nhập mới và nhập lại mật khẩu. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">YÊU CẦU THIẾT LẬP MẬT KHẨU <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Xác nhận email đăng ký. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[150]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[150]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Cám ơn bạn đã ghi danh! Tài khoản của bạn đã được tạo. Để kích hoạt tài khoản của bạn hãy nhấp vào liên kết bên dưới: <span>*</span></label>
                    <div class="col-sm-6">
